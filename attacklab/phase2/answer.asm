...
00000000000004f0 <_start>:
 ...
 50d:	48 8d 3d f3 00 00 00 	lea    0xf3(%rip),%rdi        # 607 <main>
...
00000000000005fa <fun>:
 5fa:	48 c7 c7 fa 97 b9 59 	mov    $0x59b997fa,%rdi
 601:	e8 e6 11 40 00       	callq  4017ec <_end+0x2007d4>
 606:	c3                   	retq   

0000000000000607 <main>:
